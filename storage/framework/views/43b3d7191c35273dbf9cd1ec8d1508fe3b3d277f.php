...
<div class="container-fluid content">
	...
	<div class="input-group justify-content-center">
	    ...
	    <?php endif; ?>
	    <form class="shadow-lg p-5 bg-light m-5" action="<?php echo e(route('productPurchases.queryStore')); ?>" method="post">
		<?php echo csrf_field(); ?>
		<div class="row">
		    <div class="col-auto">
		...
		<div class="row">
		    ...
		    <div class="col">
			<label>Add row</label>
			<button type="button" data-id="" class="addRow btn btn-info">+</button>
		    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('click','.addRow', function () {
            ...
            $.ajax({
                url: "<?php echo e(url('/product-purchases/add-row')); ?>",
                type: "POST",
                dataType: 'json',
                cache: false,
                headers: {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\shahadat_laravel\resources\views/productPurchases/query.blade.php ENDPATH**/ ?>