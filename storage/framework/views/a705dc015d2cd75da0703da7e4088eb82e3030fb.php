        ...
        <div class="container-fluid text-center">
            ...
            <div class="row">
                <form class="d-flex col-4" name="search" method="POST"
                    action="<?php echo e(route('productPurchases.orderSearch', $keyword)); ?>">
                    <?php echo csrf_field(); ?>
            ...
            <div class="row">
                ...
                <div class="col-2">
                    <form class="d-flex" action="<?php echo e(route('productPurchases.orderLimit')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\shahadat_laravel\resources\views/productPurchases/orderList.blade.php ENDPATH**/ ?>