...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper" id="app">
        <nav class="navbar navbar-expand navbar-dark">
            <!-- Brand Logo -->
            <a href="<?php echo e(url('/')); ?>" class="brand-link font-light">
                <img src="<?php echo e(asset('public/dist/img/s_logo.png')); ?>" alt="Brand Logo"
        ...
        <div class="container content mt-3">
            <div class="container-fluid text-center">
                ...
                <div class="input-group justify-content-center">
                    <form class="shadow-lg p-5 bg-light m-5" method="POST" action="<?php echo e(route('login')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH E:\Xampp\htdocs\shahadat_laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>