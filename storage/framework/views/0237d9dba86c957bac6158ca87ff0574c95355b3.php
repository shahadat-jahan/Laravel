        ...
        <div class="container content mt-3">
            <div class="container-fluid text-center">
                ...
                <div class="input-group justify-content-center">
                    <form class="shadow-lg p-4 bg-light m-5" method="POST" action="<?php echo e(route('register')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH E:\Xampp\htdocs\shahadat_laravel\resources\views/auth/register.blade.php ENDPATH**/ ?>